<template>
  <div id="about-us">
    ...
    <div class="about-us-img">
      ...
      <div class="container">
        <img class="img-map" src="~/assets/images/pinMap.png" alt="" />
      </div>
    </div>
  </div>
</template>
...
.content-about-us-right .block-us-right {
  margin-bottom: 41.62px;
}

.content-about-us-right .icon-about-us {
  padding: 0;
  width: 50px;
  height: 50px;
}
